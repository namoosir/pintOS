...
syscall_handler (struct intr_frame *f UNUSED) 
{
  ...
  else if (syscall_number == SYS_REMOVE)
  {
    ...
    /*
      We do some parsing for relative and absolute paths
    */
    char* path = (char*)args[0];
  ...
  else if (syscall_number == SYS_MUNMAP)
  {
    ...
    */
    ...
    /*
      Frees the mapped item from the mapping_info_list
    */
    if (map_exists) {
  ...
  // Make directory, takes absolute or relative path as argument
  ...
  //Read directory and return one entry given absolute or relative path
  ...
  //Given a file descriptor, return true if it represents a directory and false otherwise
  ...
  //Given a file descriptor, return its inumber
