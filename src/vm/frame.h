...
struct single_frame_entry* frame_evict(void);
struct single_frame_entry* get_frame_at_index(int index);
void increment_clock_pointer(void);
struct single_frame_entry* approximate_LRU(void);
#endif /* vm/frame.h */
